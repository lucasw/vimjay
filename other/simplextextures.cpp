...
float marble_noise_3d(const float octaves, const float persistence,
...
float marble_noise_4d(const float octaves, const float persistence,
    const float scale, const float x, const float y, const float z, const float w)
{
